...
class RecipeCard extends HTMLElement {
  ...
  constructor() {
    ...
    let cardTemplate_string = `<!-- This is a template for you to reference when making your cards.
You won't need to access this file from your code, this is the code
you'll copy from when making your template literals or inserting
styles into the <style> element of your RecipeCard.js-->

<!-- Markup -->
<!-- FAKE VALUES HAVE BEEN INCLUDED, just for reference, you will need to replace
	the attribute values and element content with data -->
<article>
 ...
 * {
 ...
 time {
   ...
   font-size: 12px;
    ...
    elementStyle.innerHTML = cardTemplate_string;
